...
int jdi_release(JdiDeviceCtx devctx);    //this function may be called only at system off.
...
JPU_DMA_CFG jdi_config_mmu(JdiDeviceCtx devctx,int input_buffer_fd,int output_buffer_fd,unsigned int dataSize,unsigned int appendingSize);
