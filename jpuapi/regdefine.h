...
#define MJPEG_PIC_START_REG \
  (NPT_BASE +               \
   0x000)  // [3] - start partial encoding  [2] - pic stop en/decoding[1] - pic
           // init en/decoding [0] - pic start en/decoding
#define MJPEG_PIC_STATUS_REG \
  (NPT_BASE +                \
   0x004)  // [8] - stop [7:4] - partial buffer interrupt [3] - overflow, [2] -
           // bbc interrupt, [1] - error, [0] - done
#define MJPEG_PIC_ERRMB_REG \
  (NPT_BASE + 0x008)  // [27:24] - error restart idx, [23:12] - error MCU pos X,
                      // [11:0] - error MCU pos Y
#define MJPEG_PIC_SETMB_REG \
  (NPT_BASE + 0x00C)  // [27:16] - MCU pos X, [11:0] - MCU pos Y

#define MJPEG_PIC_CTRL_REG \
  (NPT_BASE +              \
   0x010)  // [12:7] huffman table index [6] - user huffman en, [4] - TC
           // direction, [3] - encoder enable, [1:0] - operation mode
#define MJPEG_PIC_SIZE_REG (NPT_BASE + 0x014)
#define MJPEG_MCU_INFO_REG (NPT_BASE + 0x018)
#define MJPEG_ROT_INFO_REG \
  (NPT_BASE + 0x01C)  // [4] - rot-mir enable, [3:0] - rot-mir mode

#define MJPEG_SCL_INFO_REG (NPT_BASE + 0x020)
#define MJPEG_IF_INFO_REG \
  (NPT_BASE +             \
   0x024)  // [1] - sensor interface clear, [0] - display interface clear
#define MJPEG_CLP_INFO_REG (NPT_BASE + 0x028)
#define MJPEG_OP_INFO_REG \
  (NPT_BASE + 0x02C)  // [31:16] - # of line in 1 partial buffer, [5:3] - # of
                      // partial buffers [2:0] - # of request
...
#define MJPEG_BBC_STRM_CTRL_REG \
  (NPT_BASE + 0x234)  // [31] - end of bitstream file  [23:0] - stream counter
...
#define JPU_MMU_OFFSET 0x500

#define JPU_MMU_TRI (0x400)

#define JPU_MMU_TOP (JPU_MMU_OFFSET + 0x00)
#define JPU_MMU_TBU0 (JPU_MMU_OFFSET + 0x40)
#define JPU_MMU_TBU1 (JPU_MMU_OFFSET + 0x60)
#define JPU_MMU_TBU2 (JPU_MMU_OFFSET + 0x80)

#define JPU_MMU_VERSION (JPU_MMU_TOP + 0x3C)
#define JPU_MMU_BVA_LO (JPU_MMU_TOP + 0x00)
#define JPU_MMU_BVA_HI (JPU_MMU_TOP + 0x04)
#define JPU_MMU_IRQ_STATUS (JPU_MMU_TOP + 0x10)
#define JPU_MMU_IRQ_ENABLE (JPU_MMU_TOP + 0x14)

#define JPU_MMU_TTBLR0 (JPU_MMU_TBU0 + 0x00)
#define JPU_MMU_TTBHR0 (JPU_MMU_TBU0 + 0x04)
#define JPU_MMU_TCR0 (JPU_MMU_TBU0 + 0x08)
#define JPU_MMU_TBU0_STATUS (JPU_MMU_TBU0 + 0x10)
#define JPU_MMU_TTBLR1 (JPU_MMU_TBU1 + 0x00)
#define JPU_MMU_TTBHR1 (JPU_MMU_TBU1 + 0x04)
#define JPU_MMU_TCR1 (JPU_MMU_TBU1 + 0x08)
#define JPU_MMU_TBU1_STATUS (JPU_MMU_TBU1 + 0x10)
