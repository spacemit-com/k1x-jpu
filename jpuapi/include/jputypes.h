...
typedef enum {
    ...
    JPU_ROTATION,               /*rotation Uint32 0: 0, 1: 90 CCW, 2: 180 CCW, 3: 270 CCW CCW(Counter Clockwise) default 0*/
    JPU_MIRROR,                 /*mirror Uint32 0: none, 1: vertical mirror, 2: horizontal mirror, 3: both default 0*/
    ...
    JPU_DISABLE_APP_MARKER,     /*disable image header app maker Uint32 0: enable 1:disable  defaut 0 */
    JPU_DISABLE_SOI_MARKER,     /*disable image header soi maker Uint32 0: enable 1:disable  defaut 0 */
    JPU_ENABLE_SOF_STUFFING,    /*enable image header sof stuffing Uint32 0: enable 1:disable  defaut 0 */
    JPU_IMAGE_ENDIAN,          /*the endian of stream  EndianMode default JDI_LITTLE_ENDIAN*/
    JPU_FRAME_BUF_ENDIAN,           /*the endian of frame  EndianMode default JDI_LITTLE_ENDIAN */
} JpuParamIndex;
