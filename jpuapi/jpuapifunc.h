...
#define JpuWriteInstReg( devctx, INST_IDX, ADDR, DATA )		jdi_write_register( devctx, ((unsigned long)INST_IDX*NPT_REG_SIZE)+ADDR, DATA ) // system register write 	with instance index
#define JpuReadInstReg( devctx, INST_IDX, ADDR )		        jdi_read_register( devctx, ((unsigned long)INST_IDX*NPT_REG_SIZE)+ADDR ) // system register write 	with instance index
#define JpuWriteReg( devctx, ADDR, DATA )                     jdi_write_register( devctx, ADDR, DATA ) // system register write
#define JpuReadReg( devctx, ADDR )                            jdi_read_register( devctx, ADDR )           // system register write
#define JpuWriteMem( devctx, ADDR, DATA, LEN, ENDIAN )        jdi_write_memory( devctx, ADDR, DATA, LEN, ENDIAN ) // system memory write
#define JpuReadMem( devctx, ADDR, DATA, LEN, ENDIAN )         jdi_read_memory( devctx, ADDR, DATA, LEN, ENDIAN ) // system memory write
