...
extern BOOL GetJpgEncOpenParam(EncOpenParam *pEncOP, EncConfigParam *pEncConfig);
...
extern FrameBufferInfo* AllocateFrameBuffer(BufferAllocator*  bufferAllocator,Uint32 instIdx, FrameFormat subsample, CbCrInterLeave cbcrIntlv, PackedFormat packed, 
...
extern Uint32 BitstreamFeeder_Act(BSFeeder feeder, JpgDecHandle handle, ImageBufferInfo *bsBuffer);
