...
typedef struct YuvFeederImpl {
    void*   context;
    BOOL    (*Create)(AbstractYuvFeeder* feeder, const char* path, JdiDeviceCtx devctx);
    Int32   (*Feed)(AbstractYuvFeeder* feeder, FrameBufferInfo* fb, Uint32 endian,BufferAllocator* bufferAllocator);
